...
class TaskModel extends Model
{
    ...
    protected $allowedFields = ['id', 'title', 'content', 'tags', 'duedate', 'startdate', 'cover', 'done', 'altTags', 'estimate', 'spent', 'progress', 'user', 'assignee', 'stack', 'info', 'archived', 'created', 'updated'];
